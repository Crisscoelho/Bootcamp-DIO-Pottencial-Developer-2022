...
namespace Desafio_Tech_Pottencial.Controllers
{
 [ApiController]
    [Route("[controller]")]
    public class VendaController : ControllerBase
    {
        ...
        public IActionResult ObterPorId(int id)
        {
            ...
            Finalizada.Venda.Response.Venda fVenda = new Finalizada.Venda.Response.Venda()
            {
                VendaID = venda.Id,
                Data = venda.Data,
                Status = venda.Status,
                Vendedor = new Finalizada.Venda.Vendedor()
                {
                    Nome = vendedor.Nome,
                    CPF = vendedor.CPF,
            ...
            {
                fVenda.Itens.Add(new Finalizada.Venda.Item()
                {
                    Nome = item.Nome,
        ...
        [HttpPost]
        public IActionResult Criar(Finalizada.Venda.Request.CriarVenda venda)
        {
            ...
            if(erros.Count > 0)
            {
                ...
                foreach(Finalizada.Venda.Item item in venda.Itens)
                {
        ...
        public IActionResult AlterarStatus(Finalizada.Venda.Request.AlterarStatus req)
        {
